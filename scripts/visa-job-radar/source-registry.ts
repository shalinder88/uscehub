...
export const SOURCES: SourceDef[] = [
  ...
  },
  {
    ...
    enabled: false,
    needsVerification: true,
    note: "DISABLED 2026-06-13: wd5 Workday CDN currently degraded (HTML 200 to all wd5 CXS requests). Handle confirmed 2026-06-13 from roswellpark.org/careers page source (href to roswellpark.wd5.myworkdayjobs.com/ExternalCareers). DOL iron-core: 'roswell park cancer institute' 7yr/45pos FY2025. NY state cancer center (Buffalo). Re-enable when wd5 CDN recovers.",
  },
  {
    id: "workday-urmc",
    tier: 1,
    ...
    enabled: false,
    needsVerification: true,
    note: "DISABLED 2026-06-13: wd5 Workday CDN currently degraded (HTML 200 to all wd5 CXS requests). Handle confirmed 2026-06-13 from urmc.rochester.edu careers page source (observed redirect to rochester.wd5.myworkdayjobs.com/UR_Staff/job). DOL iron-core: 'university of rochester' 6yr/35pos FY2025. UR_Staff is the general UR Workday site covering all UR jobs including URMC clinical/academic. May also cover Unity Hospital of Rochester (7yr/24pos). Re-enable when wd5 CDN recovers.",
  },
  {
    ...
    enabled: false,
    needsVerification: true,
    note: "DISABLED 2026-06-13: wd5 Workday CDN currently degraded (HTML 200 to all wd5 CXS requests). Handle confirmed from careers.rochesterregional.org careers page redirect to rrhs.wd5.myworkdayjobs.com/RRH. DOL iron-core sponsor (7/7 years FY2019-FY2025, 110 recentYearPositions FY2025). normKey 'rochester general hospital' direct persistence_index match. Rochester Regional Health System (RRHS) is the parent. Re-enable when wd5 CDN recovers — expected to yield 30-60 SPONSOR_LEAD per run.",
  },
  {
    ...
    enabled: false,
    needsVerification: true,
    note: "DISABLED 2026-06-13: wd1 Workday CDN currently degraded (all wd1 CXS requests return HTML). Handle confirmed 2026-06-13 from careers.bmc.org/jobs/search page source (findWDSite found bmc.wd1.myworkdayjobs.com/en-US/BMC redirect). DOL iron-core: 'boston medical center corporation' 7yr/24pos FY2025. Safety-net academic medical center, Boston MA. employer matches normKey 'boston medical center'. Re-enable when wd1 CDN recovers.",
  },
  {
    id: "workday-ahn",
    tier: 1,
    ...
    enabled: false,
    needsVerification: true,
    note: "DISABLED 2026-06-13: wd1 Workday CDN currently degraded (wd1 CXS returns HTML). Handle confirmed 2026-06-13 from ahn.org/careers page source — page redirects to careers.highmarkhealth.org; Workday job URLs embed highmarkhealth.wd1.myworkdayjobs.com/highmark/job/... AHN is part of Highmark Health (Blue Cross/Blue Shield + AHN). DOL iron-core: 'allegheny clinic' 7yr/31pos FY2025 (normKey direct match). Requires EMPLOYER_ALIAS in sponsor-universe.ts: 'allegheny health network' → 'allegheny clinic'. Re-enable when wd1 CDN recovers.",
  },
  {
    id: "workday-mcw",
    tier: 1,
