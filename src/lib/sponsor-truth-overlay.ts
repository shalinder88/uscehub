...
export const LIVE_NOTICE_EMPLOYERS = new Map<string, LiveNoticeEmployer>([
  ["university of kansas medical center", {
    ...
    state: "KS",
    latestNoticeAt: "2026-06-12T03:09:35.866Z",
    notices: [
