...
export const WAIVER_STATES: Record<string, WaiverState> = {
  ...
  TX: {
    ...
    specialtyNeeds: ["Family Medicine", "Internal Medicine", "Psychiatry", "Pediatrics", "OB/GYN", "General Surgery"],
    requirements:
      "Must serve in a HPSA or MUA for 3 years. Texas DSHS administers the Conrad 30 program. Texas has a flex option in policy (up to 10 flex slots) but DSHS has not activated flex eligibility for FY2025/FY2026 — effectively 0 flex in practice currently. No state income tax. $3,000 application fee (refundable if not recommended). Full unrestricted TX medical license required.",
