...
export const WAIVER_STATES: Record<string, WaiverState> = {
  ...
  TX: {
    ...
    specialtyNeeds: ["Family Medicine", "Internal Medicine", "Psychiatry", "Pediatrics", "OB/GYN", "General Surgery"],
    requirements:
      "Must serve in a HPSA or MUA for 3 years. Texas DSHS administers the Conrad 30 program. Texas offers up to 10 flex slots but restricts them to the SECOND HALF of the fiscal year (April-September), with exceptions for state hospitals/living centers. No state income tax. Employer must be in a HPSA or MUA. Texas accepts specialists beyond primary care. Full unrestricted Texas medical license required. $3,000 application fee.",
    tips: "Texas is widely considered one of the best states for J-1 waivers. All 30 standard slots fill very quickly — often within the first days of October 1. But Texas does offer up to 10 flex slots in the second half of the fiscal year (April-September) — this is a second chance if you miss the initial window. No state income tax. Rio Grande Valley, West Texas (El Paso, Lubbock, Midland-Odessa), and East Texas (Tyler, Longview, Texarkana) have the highest HPSA scores. Also consider HHS Clinical Care Waiver (unlimited slots) as alternative. $3,000 application fee. Start employer search 8-10 months before deadline.",
