...
export const WAIVER_JOBS: WaiverJob[] = [
  ...
  // ═══ H-1B VERIFIED EMPLOYER POSITIONS (March 2026) ═══
  {
    ...
    salaryMin: 428000,
    salaryMax: 639000,
    description: "Clinical/General Cardiologist at Cleveland Clinic. H-1B and J-1 sponsorship confirmed in job posting. Cap-exempt (Lerner College of Medicine affiliation).",
    sourceUrl: "https://jobs.clevelandclinic.org/job/16185509/clinical-general-cardiologist-j1-h1b-sponsorship-support-cleveland-oh/",
  ...
  {
    id: "h1b-cc-cards-002",
    employer: "Cleveland Clinic Union Hospital",
    city: "Dover",
    state: "OH",
    specialty: "Cardiology",
    visaTypes: ["h1b"],
    hpsa: false,
    description: "Clinical Cardiologist Specialist at Cleveland Clinic Union Hospital, Dover OH. Cap-exempt through Cleveland Clinic academic affiliation.",
    sourceUrl: "https://jobs.clevelandclinic.org/job/18269528/clinical-cardiologist-specialist-dover-oh/",
    sourceName: "Cleveland Clinic Careers",
  ...
  {
    id: "h1b-sound-hosp-001",
    employer: "Sound Physicians / John Peter Smith Hospital",
    city: "Burleson",
    state: "TX",
    specialty: "Hospitalist",
    visaTypes: ["h1b", "j1"],
    hpsa: false,
    schedule: "7-on/7-off",
    description: "Hospital Medicine at JPS/Texas Health Huguley. Sound Physicians pays ALL immigration filing fees. In-house immigration team.",
    sourceUrl: "https://careers.soundphysicians.com/job/burleson/hospital-medicine-physician/48983/92065626912",
    sourceName: "Sound Physicians Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
    jobType: "full-time",
  ...
  {
    id: "h1b-sound-noct-001",
    employer: "Sound Physicians / Henry Ford Genesys Hospital",
    city: "Grand Blanc",
    state: "MI",
    specialty: "Hospitalist",
    subspecialty: "Nocturnist",
    visaTypes: ["h1b", "j1"],
    hpsa: false,
    description: "Nocturnist at Henry Ford Genesys Hospital. Sound Physicians handles full visa process and pays all filing fees.",
    sourceUrl: "https://careers.soundphysicians.com/job/grand-blanc/hospital-medicine-physician-nocturnist/48983/91407126368",
    sourceName: "Sound Physicians Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
  ...
  {
    id: "h1b-sound-icu-001",
    employer: "Sound Physicians / SSM Health DePaul Hospital",
    city: "Bridgeton",
    state: "MO",
    specialty: "Critical Care",
    visaTypes: ["h1b"],
    hpsa: false,
    description: "Intensivist at SSM Health DePaul Hospital (St. Louis area). SSM Health is a nonprofit system. Sound Physicians handles immigration.",
    sourceUrl: "https://careers.soundphysicians.com/job/intensivist-physician-st-louis-missouri",
    sourceName: "Sound Physicians Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
  ...
  {
    id: "h1b-sound-noct-002",
    employer: "Sound Physicians / UF Health Jacksonville",
    city: "Jacksonville",
    state: "FL",
    specialty: "Hospitalist",
    subspecialty: "Nocturnist",
    visaTypes: ["h1b", "j1"],
    hpsa: false,
    description: "Nocturnist at UF Health Jacksonville. Cap-exempt through University of Florida affiliation. Sound Physicians pays all filing fees.",
    sourceUrl: "https://careers.soundphysicians.com/job/nocturnist-jacksonville-fl",
    sourceName: "Sound Physicians Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
  ...
  },
  {
    ...
    visaTypes: ["h1b"],
    hpsa: false,
    description: "Family Medicine Physician at UPMC Hamot, Erie PA. Cap-exempt (University of Pittsburgh affiliation). PSLF eligible.",
    sourceUrl: "https://careers.upmc.com/job/17998957/family-medicine-physician-pennsylvania-/",
    sourceName: "UPMC Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
    jobType: "full-time",
  ...
  {
    id: "h1b-upmc-pc-001",
    employer: "UPMC Western Maryland",
    city: "Cumberland",
    state: "MD",
    specialty: "Internal Medicine",
    visaTypes: ["h1b", "j1"],
    hpsa: false,
    schedule: "Weekdays only, no weekends",
    description: "Primary Care (FM/IM) at UPMC Western Maryland. H-1B and J-1 sponsorship confirmed. Cap-exempt, PSLF eligible. Sign-on bonus included.",
    sourceUrl: "https://careers.upmc.com/job/22563393/primary-care-physician-fm-im-western-maryland-locations-upmc-cumberland-md/",
    sourceName: "UPMC Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
    jobType: "full-time",
    capExempt: true,
    benefits: ["Sign-on bonus", "Weekdays only", "PSLF eligible"],
  },
  {
    id: "h1b-rrh-hosp-001",
    ...
    hpsa: false,
    signOnBonus: 30000,
    description: "Hospitalist, Medical Short Stay Unit at Rochester General Hospital. H-1B and J-1 confirmed. $30,000 sign-on bonus.",
    sourceUrl: "https://careers.rochesterregional.org/career-opportunities/req_123404/hospitalist-medical-short-stay-unit/",
    sourceName: "Rochester Regional Health Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
    jobType: "full-time",
    benefits: ["$30K sign-on bonus"],
  },
  {
    id: "h1b-ucsf-sports-001",
    employer: "UCSF Department of Orthopaedic Surgery",
    city: "San Francisco",
    state: "CA",
    ...
    salaryMin: 154700,
    salaryMax: 900000,
    salaryNote: "Base $154,700; total compensation up to $900,000 including clinical incentives.",
    description: "Primary Care Sports Medicine faculty at UCSF. Cap-exempt (UC system). Base salary plus clinical incentives can reach $900K.",
    sourceUrl: "https://aprecruit.ucsf.edu/JPF05844",
    sourceName: "UCSF AP Recruit",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
    jobType: "full-time",
  ...
  },
  {
    ...
    salaryMin: 240000,
    salaryMax: 250000,
    description: "Primary Care Physician at Northwestern Medicine, Chicago. Cap-exempt (Northwestern University affiliation).",
    sourceUrl: "https://jobs.nm.org/job/chicago/primary-care-physicians-chicago/27763/63121526416",
    sourceName: "Northwestern Medicine Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
    jobType: "full-time",
  ...
  },
  {
    ...
    visaTypes: ["h1b"],
    hpsa: false,
    description: "Hospitalist at Duke University Hospital, Duke Regional, and Duke Raleigh. Cap-exempt (Duke University affiliation).",
    sourceUrl: "https://careers.dukehealth.org/us/en/job/DUHDUHUS264086EXTERNALENUS/Hospitalist-Physician-Duke-University-Duke-Regional-and-Duke-Raleigh-Hospitals",
    sourceName: "Duke Health Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
    jobType: "full-time",
  ...
  },
  {
    ...
    visaTypes: ["h1b"],
    hpsa: false,
    description: "Primary Care Physician at Emory Healthcare. Cap-exempt (Emory University). 431 LCAs filed in FY2025.",
    sourceUrl: "https://emory.jobs/atlanta-ga/physician-primary-care-esa/7E7023B43B8C4A3694435E6244270090/job/",
    sourceName: "Emory Careers",
    postedDate: "2026-01-01",
    lastVerified: "2026-03-28",
    verificationStatus: "verified",
    jobType: "full-time",
