...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Browse our listings to find programs that match your interests and qualifications. Each listing includes specific application instructions. Some programs accept applications directly through our platform, while others redirect you to the institution's application portal. Make sure you meet the eligibility requirements before applying, including any USMLE score or ECFMG certification requirements.",
  },
  {
