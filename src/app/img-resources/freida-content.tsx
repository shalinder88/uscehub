    ...
    <div className="space-y-8">
      ...
      <div>
        <h3 className="mb-3 text-base font-bold text-slate-900 dark:text-white">
          2026 Match by Specialty — IMG Fill Rates
        </h3>
            ...
            <tbody>
              {SPECIALTY_DATA.slice(0, 10).map((s, i) => (
                <tr key={s.name} className={i % 2 === 0 ? "bg-white dark:bg-slate-900" : "bg-slate-50/50 dark:bg-slate-800/30"}>
                  ...
                  <td className="px-3 py-2.5 text-right text-slate-600 dark:text-slate-300">{s.positions.toLocaleString()}</td>
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-slate-600 dark:text-slate-400">
        14 specialties ranked by IMG accessibility. Data from NRMP 2026 Match and Charting Outcomes.
      </p>
      {SPECIALTY_DATA.map((s) => (
        <div key={s.name} className="rounded-xl border border-slate-200 dark:border-slate-700 p-5">
          ...
          <div className="mt-3 flex flex-wrap gap-4 text-xs text-slate-500 dark:text-slate-400">
            <span><strong className="text-slate-900 dark:text-white">{s.positions.toLocaleString()}</strong> positions</span>
      ...
      <div className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900">
        <div className="mx-auto max-w-7xl px-4 py-2.5 sm:px-6 lg:px-8">
          <p className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-slate-500 dark:text-slate-400">
            ...
            <span>•</span>
            <a href="https://www.nrmp.org/match-data/" target="_blank" rel="noopener noreferrer" className="underline hover:text-slate-700 dark:hover:text-slate-300">NRMP 2026</a>
            <span>•</span>
