...
const pathways: Pathway[] = [
  ...
  },
  {
    ...
    processing: "12+ months at HHS alone, plus DOS and USCIS processing",
    specialties: "Primary care only: Family Medicine, General Internal Medicine, General Pediatrics, OB/GYN, General Psychiatry",
    coverage: "Nationwide — any facility in a HPSA with score 7+",
    requirements: [
    ...
    cons: [
      "Processing takes 12+ months at HHS — much slower than Conrad 30",
  ...
  },
  {
    ...
    coverage:
      "Appalachian communities across 13 states: AL, GA, KY, MD, MS, NY, NC, OH, PA, SC, TN, VA, WV",
    requirements: [
  ...
  },
  {
    ...
    shortName: "DRA",
    icon: TreePine,
    slots: "Unlimited — rolling applications",
    fee: "Varies",
    processing: "Typically 3-6 months",
    specialties: "Primary care and specialists with proof of need",
    coverage:
      "252 counties/parishes across 8 states: AL, AR, IL, KY, LA, MS, MO, TN",
    requirements: [
  ...
  },
  {
    ...
    shortName: "SCRC",
    icon: Sun,
    slots: "Unlimited — launched 2022",
    fee: "$3,000 application processing fee",
    processing: "Relatively new — processing times still stabilizing",
    specialties: "Primary care, psychiatry, and subspecialists accepted",
    coverage:
      "428 counties across 7 states: AL, FL, GA, MS, NC, SC, VA",
    requirements: [
    ...
    pros: [
      ...
      "Covers Florida, Georgia, North Carolina — high-demand states",
      "Accepts subspecialists",
      "Alternative when Conrad slots fill in covered states",
    ],
    cons: [
      "$3,000 application fee — highest of any pathway",
      "Newest program (2022) — less track record and guidance available",
      "Limited to 428 counties in 7 southeastern states",
      "Processing times not yet well-established",
    ],
    url: "https://scrc.gov",
    color: "text-danger",
  },
