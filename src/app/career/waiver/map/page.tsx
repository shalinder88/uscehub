  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {selectedData ? (
              ...
              {selectedData.alternativePathways.length > 0 && (
                <div className="mt-4 pt-4 border-t border-border">
                  <h3 className="text-xs font-semibold text-foreground mb-2">
                    Alternative Pathways (Unlimited)
                  </h3>
                  <div className="flex flex-wrap gap-1.5">
                    {selectedData.alternativePathways.map((p) => (
                      <span
                        key={p}
                        className="rounded px-2 py-0.5 text-xs font-medium bg-accent/10 text-accent"
                      >
                        {p}
                      </span>
                    ))}
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted">
                Click a state on the map to see waiver details.
              </p>
            </div>
          )}
      ...
      <p className="mt-6 text-xs text-muted">
        Data from{" "}
        <a
          href="https://www.3rnet.org/j1-filled"
          target="_blank"
        ...
        FY 2024 confirmed data and 20-year historical trends.
      </p>
    </div>
  );
}
