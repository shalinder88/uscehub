...
const PATHWAYS: PathwayProcess[] = [
    ...
    steps: [
      {
        ...
        duration: "3-6 months",
        details: "Find HPSA-designated employer, negotiate contract (no non-compete), obtain state medical license. Hire immigration attorney.",
      },
      {
        agency: "Employer + Attorney",
        action: "Prepare waiver application package",
        form: "State-specific application forms",
        duration: "2-4 weeks",
      ...
      {
        agency: "USCIS",
        action: "Waiver approval + H-1B petition adjudication",
        form: "I-612 (waiver) + I-129 (H-1B petition)",
        duration: "15 days (premium) or 3-6 months (regular)",
        details: "Your attorney files both the I-612 waiver application and I-129 H-1B petition with USCIS. STRONGLY use premium processing ($2,965) for the H-1B — 15 business day guarantee. Regular processing: 3-6 months.",
      },
      {
        agency: "USCIS",
        ...
        details: "I-797 is your proof of approved H-1B status. You can now work for the sponsoring employer. If you need to travel abroad, you'll need a visa stamp at a US consulate before reentry.",
      },
      {
        agency: "You",
  ...
  },
  {
    ...
    steps: [
      ...
      {
        agency: "State J-1 Coordinator",
        action: "State reviews application and prepares governor's recommendation",
        duration: "2-6 weeks",
        details: "Contact your state's ARC J-1 program coordinator (list at arc.gov). State reviews, then the governor submits a written recommendation to ARC. Each state has its own coordinator and timeline.",
      },
      {
        agency: "ARC (Federal)",
