      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
          {[
            ...
            { name: "Radiology/IR", slug: "radiology", salary: "$437-575K+" },
            { name: "Anesthesiology", slug: "anesthesiology", salary: "$300-400K+" },
            { name: "Psychiatry", slug: "psychiatry", salary: "$250-380K" },
            { name: "OB/GYN", slug: "ob-gyn", salary: "$250-350K" },
            { name: "Infectious Disease", slug: "infectious-disease", salary: "$250-325K" },
