...
const JOURNEY_STAGES: JourneyStage[] = [
  ...
  },
  {
    ...
    description: "After DOS issues a favorable waiver recommendation, your employer files an H-1B petition with USCIS. Premium processing ($2,805) gives 15-day adjudication — strongly recommended.",
    icon: Globe,
    color: "bg-cyan-500",
    actions: [
      "Employer files I-129 H-1B petition",
      "Use premium processing ($2,805) — don't wait 6 months",
