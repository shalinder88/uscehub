...
export default function RecommendPage() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center bg-white dark:bg-slate-900 dark:bg-slate-900">
  ...
  if (showResults) {
    return (
      <div className="bg-white dark:bg-slate-900 dark:bg-slate-900">
        <div className="border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 dark:bg-slate-800">
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="mb-6 flex flex-wrap gap-2">
            {answers.budget && answers.budget !== "any" && (
              <span className="inline-flex items-center gap-1 rounded-full bg-slate-100 dark:bg-slate-800 px-3 py-1 text-xs font-medium text-slate-700 dark:text-slate-300 dark:text-slate-300">
          ...
          {results.length > 0 ? (
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-20 text-center">
              <div className="mx-auto max-w-sm">
                ...
                <p className="mt-4 text-lg font-medium text-slate-900 dark:text-slate-100 dark:text-slate-100">
    ...
    <div className="bg-white dark:bg-slate-900 dark:bg-slate-900">
      ...
      <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6">
        ...
        <div className="mb-8">
          ...
          <div className="mt-2 h-1.5 w-full rounded-full bg-slate-100 dark:bg-slate-800 dark:bg-slate-800">
            <div
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 dark:bg-slate-800">
            <Icon className="h-6 w-6 text-slate-700 dark:text-slate-300 dark:text-slate-300" />
          </div>
          ...
          {currentStep.options.map((option) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-slate-900 dark:text-slate-100 dark:text-slate-100">{option.label}</p>
