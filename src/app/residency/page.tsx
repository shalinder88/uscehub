...
const statCards = [
  {
    ...
    count: "20+",
    description: "Curated tools, references & podcasts",
    icon: BookOpen,
  ...
  },
  {
    ...
    count: "10+",
    description: "Programs with visa & match data",
    icon: GraduationCap,
  ...
  },
  {
    title: "Board Exams",
    count: "6",
    description: "Major specialty board guides",
    icon: ClipboardCheck,
  ...
  },
  {
    ...
    count: "Coming Soon",
    description: "Resident discussions & advice",
    icon: Users,
    href: "/residency/community",
    color: "text-warning",
  ...
  },
  {
    title: "Survival Tips",
    count: "4 Sections",
    description: "PGY-1 through PGY-3+ guides",
    icon: HeartPulse,
