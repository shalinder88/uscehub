...
export function TermsGate() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="w-full max-w-lg rounded-2xl bg-surface shadow-2xl border border-border overflow-hidden">
        {/* Header */}
        ...
        <div className="px-6 pb-4">
          <div className="rounded-lg bg-surface-alt p-4 text-xs text-muted space-y-2">
            <p>By using USCEHub, you acknowledge and agree that:</p>
            <ul className="space-y-1.5 ml-3 list-disc">
              <li>USCEHub is an <strong className="text-foreground">informational directory only</strong> — not a placement agency, medical advisor, or guarantor of any program</li>
              <li>We provide <strong className="text-foreground">no guarantees</strong> regarding accuracy, availability, or quality of listed programs</li>
              <li>You <strong className="text-foreground">assume all risks</strong> related to applications, clinical experiences, and interactions with institutions</li>
              <li>USCEHub has <strong className="text-foreground">no liability</strong> for any damages, losses, injuries, or outcomes</li>
              <li>Disputes are resolved through <strong className="text-foreground">binding arbitration</strong> — you waive class action rights</li>
              <li>You agree to our <strong className="text-foreground">Privacy Policy</strong> and data practices</li>
            </ul>
          </div>
        </div>
        ...
        <div className="px-6 pb-4">
          ...
          {expanded && (
            <div className="mt-3 max-h-60 overflow-y-auto rounded-lg border border-border bg-surface p-4 text-[11px] leading-relaxed text-muted space-y-4">
              <div>
              ...
              <div>
                <p className="font-semibold text-foreground mb-1">2. Nature of Platform — Directory Only</p>
              ...
              <div>
                <p className="font-semibold text-foreground mb-1">3. No Professional Advice</p>
              ...
              <div>
                <p className="font-semibold text-foreground mb-1">4. No Guarantee of Accuracy</p>
              ...
              <div>
                <p className="font-semibold text-foreground mb-1">5. Assumption of Risk</p>
              ...
              <div>
                <p className="font-semibold text-foreground mb-1">12. DISCLAIMER OF WARRANTIES</p>
              ...
              <div>
                <p className="font-semibold text-foreground mb-1">13. LIMITATION OF LIABILITY</p>
              ...
              <div>
                <p className="font-semibold text-foreground mb-1">14. Indemnification</p>
              ...
              <div>
                <p className="font-semibold text-foreground mb-1">15. Binding Arbitration &amp; Class Action Waiver</p>
        ...
        <div className="border-t border-border bg-surface-alt px-6 py-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 rounded-lg border border-border bg-surface px-4 py-2.5 text-sm font-medium text-foreground hover:bg-surface-alt transition-colors"
            >
              Decline
            </button>
            <button
